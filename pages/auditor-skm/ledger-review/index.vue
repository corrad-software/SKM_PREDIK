...
const cooperatives = ref([
  { id: 1, name: 'KOPERASI XXXXXXXX BERHAD' },
  { id: 2, name: 'KOPERASI YYYYYYYY BERHAD' }
]);
...
const selectCooperative = (event) => {
  ...
  selectedLedger.value = ''; // Reset ledger selection
};
  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="p-4 bg-white shadow mb-4">
      <div class="flex space-x-4">
        <div>
          <label for="cooperative" class="block text-sm font-medium text-gray-700">Pilih Koperasi</label>
          <select id="cooperative" v-model="selectedCooperative" @change="selectCooperative" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
            <option value="" disabled>Pilih Koperasi</option>
            <option v-for="coop in cooperatives" :key="coop.id" :value="coop.name">{{ coop.name }}</option>
          </select>
        </div>
        <div>
          <label for="ledger" class="block text-sm font-medium text-gray-700">Pilih Penyata Kewangan</label>
          <select id="ledger" v-model="selectedLedger" @change="selectLedger" :disabled="!selectedCooperative" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
            <option value="" disabled>Pilih Penyata Kewangan</option>
