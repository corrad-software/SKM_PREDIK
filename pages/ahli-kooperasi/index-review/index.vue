...
const documentSections = ref([
  {
    ...
    items: [
      { name: 'Indeks Kertas Kerja', icon: 'ic:round-article', path: '/kertas-kerja/indeks' },
      { 
        ...
        subItems: [
          { 
            ...
            path: '/kunci-kira-kira'
          },
          { 
            name: 'Akaun Pembahagian Keuntungan',
            path: '/akaun-pembahagian-keuntungan'
          },
          { 
            name: 'Akaun Untung Rugi',
            path: '/akaun-untung-rugi'
          },
          { 
            name: 'Akaun Perdagangan',
            path: '/akaun-perdagangan',
            isExpanded: false,
            subItems: [
...
<template>
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="sticky top-0 bg-gray-50 z-10 py-6 px-4">
        ...
        <div class="bg-white rounded-lg shadow">
          <div class="p-4 flex items-center justify-between border-b border-gray-200">
            <h2 class="text-lg font-medium text-gray-900"><Icon name="ic:round-folder" class="mr-2" /> {{ documentSections[0].title }}</h2>
            <div class="relative">
              <input
                type="text"
                v-model="searchQuery"
      ...
      <!-- Scrollable content -->
      <div class="px-4 overflow-y-auto" style="max-height: calc(100vh - 180px);">
        <div class="bg-white rounded-lg shadow">
